<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <h5></h5>
            <?php echo Form::open(['url'=>'area/save', 'method'=>'POST']); ?>
        ...
        <div class="panel panel-transparent">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="v-align-middle semi-bold"><?php echo $area->name; ?></td>
                        <td class="v-align-middle"><?php echo $area->servicesCount(); ?></td>
                        <td class="v-align-middle semi-bold">
                            <a class="gallery-item" href="#" data-toggle="modal" data-target="#modal_edit_area" data-area_id="<?php echo $area->id; ?>" class="tile tile-primary">
                                <button class="btn btn-default" style="border-radius:50%; float:left;">
                                    <i class="fa fa-pencil"></i>
                                </button>
                            </a>
                            <?php echo Form::open(['url'=>'/area/delete', 'method'=>'POST', 'style'=>'display: inline-block; margin-top: 4px;', 'id'=>'deleteareaform', 'onsubmit'=>"return confirm('Cancellando questa area cancellerai anche tutti i servizi collegati ad essa. Procedere?');"]); ?>

                                <?php echo Form::hidden('area_id', $area->id); ?>
